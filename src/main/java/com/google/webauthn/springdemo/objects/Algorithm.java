...
public enum Algorithm {
     ...
     */
    public static boolean isEccAlgorithm(final Algorithm alg) {
     ...
     */
    public static boolean isRsaAlgorithm(final Algorithm alg) {
     ...
     */
    public static Algorithm decode(final String s) {
        for (final Algorithm t : Algorithm.values()) {
            if (t.name.equals(s)) {
                return t;
            }
        }
     ...
     * @return Transport corresponding to the input string
     */
    public static Algorithm decode(final int alg) {
        switch (alg) {
            case -7:
                return ES256;
            case -35:
