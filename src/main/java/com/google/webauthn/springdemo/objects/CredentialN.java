...
public class CredentialN {
    ...
    private PublicKeyCredentialN publicKeyCredential;
    ...
    public PublicKeyCredentialN getPublicKeyCredential() {
        return publicKeyCredential;
    }

    public CredentialN setPublicKeyCredential(final PublicKeyCredentialN publicKeyCredential) {
        this.publicKeyCredential = publicKeyCredential;
        return this;
    }
